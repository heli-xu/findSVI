...
var_cal2 <-
  ...
  mutate(
    ...
    census_var = str_replace_all(
      x2018_table_field_calculation,
      "[^[:alnum:][:blank:]_]",
      " "
    )
  )
...
variable_e_ep_calculation_2017 <- variable_e_ep_calculation_2018 %>%
  rename(
    x2017_variable_name = x2018_variable_name,
...
variable_e_ep_calculation_2016 <- variable_e_ep_calculation_2018 %>%
  rename(
    x2016_variable_name = x2018_variable_name,
...
var_cal2 <- variable_e_ep_calculation_2016 %>%
  mutate(census_var = str_replace_all(
    x2016_table_field_calculation,
    "[^[:alnum:][:blank:]_]",
    " "
  ))
...
variable_e_ep_calculation_2015 <- variable_e_ep_calculation_2016 %>%
  rename(
    x2015_variable_name = x2016_variable_name,
...
variable_e_ep_calculation_2014 <- variable_e_ep_calculation_2016 %>%
  rename(
    x2014_variable_name = x2016_variable_name,
...
variable_e_ep_calculation_2013 <- variable_e_ep_calculation_2014 %>%
  rename(
    x2013_variable_name = x2014_variable_name,
...
variable_e_ep_calculation_2012 <- variable_e_ep_calculation_2013 %>%
  rename(
    x2012_variable_name = x2013_variable_name,
