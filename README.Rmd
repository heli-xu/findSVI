...
* `summarise_svi()`: retrieving US census data and calculate SVI for one or multiple year-state pair(s) at the same geography level.
...
```{r summarise_results, echo=FALSE, warning=FALSE}
library(dplyr)
