...
If we plot out both versions of overall SVI for each tract, we can observe an interesting pattern, where they correlate well at both ends of the SVI spectrum but correlate poorly in the middle. 
