...
If we plot out both versions of overall SVI for each tract, we can observe an interesting pattern, where they correlate well at both ends of the SVI spectrum but correlate poorly in the middle. Quantitatively, the correlation coefficient between two versions of SVI is `r cor(join_svi$CDC_SVI, join_svi$findSVI_SVI)`, suggesting a discrepancy that perhaps warrants more discussion. 
