...
subtitle: "Correlation between SVI and COVID-19 cases/deaths in Philadelphia Neighborhoods"
...
```{r fig.cap = 'SVI and COVID-19 outcome in Philadelphia Neighborhoods (ZCTAs)'}
